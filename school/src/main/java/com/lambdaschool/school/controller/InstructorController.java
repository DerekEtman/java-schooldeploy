...
public class InstructorController {
    ...
    @ApiOperation(value = "Creates a new Instructor.", notes = "The newly created Instructor id will be sent in the " +
            "location header.", response = void.class)
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Instructor Created Successfully", response = void.class),
    ...
    @ApiOperation(value = "Updates an Instructor by Instructor Id ", response = void.class)
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Instructor Updated Successfully", response = void.class),
            @ApiResponse(code = 500, message = "Error Updating Instructor", response = ErrorDetail.class)
    } )
    ...
    @ApiOperation(value = "Deletes an Instructor by Instructor Id ", response = void.class)
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Instructor Deleted", response = void.class),
